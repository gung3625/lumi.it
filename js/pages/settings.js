    (function () {
      ...
      const IG_DIAG_GUIDES = {
        'personal-account': {
          ...
          html: `인스타 앱에서 다음 순서로 (둘 중 한 경로):<br>
            <b>빠른 길</b>: 하단 <b>본인 프로필</b> → <b>프로필 편집</b> → 아래로 스크롤 → <b>프로페셔널 계정으로 전환</b><br>
            <b>정석 경로</b>: 하단 <b>본인 프로필</b> → 우측 상단 <b>≡</b> → <b>설정 및 활동</b> → <b>계정 유형 및 도구</b> → <b>프로페셔널 계정으로 전환</b><br><br>
            전환 진행 시: 안내 → 카테고리 선택 (예: 카페) → <b>비즈니스</b> 선택 → 연락처 확인 → 마지막 <b>Facebook 페이지 연결</b> 화면.`,
        ...
        'page-not-linked': {
          title: '인스타 ↔ 페이지 연결',
          html: `인스타 앱 → 하단 <b>본인 프로필</b> → <b>프로필 편집</b> → 아래로 스크롤 →
            <b>페이지</b> 또는 <b>Facebook 페이지</b> 항목 → 위에서 만든 매장 페이지 선택.<br><br>
