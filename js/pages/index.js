      ...
      const SLIDES = [
        {
          ...
          alt:  '라떼아트 잎 패턴',
          tone: '시크 · 짧은 호흡',
          captionHtml: '오후 세 시.<br>손님 한 분, 저 한 명.<br><br>오늘은 손이 잘 됐어요.<br>잎이 깨끗하게 그려진 날 ☕',
        ...
        },
        {
          ...
          alt:  '치즈케이크 한 조각과 커피',
          tone: '친근 · 단골 톤',
          captionHtml: '치즈케이크 한 조각에<br>드립커피 한 잔.<br><br>단골 분이 "같이 먹으면 어때요?" 하셔서<br>이번 주 세트 1,000원 빼드려요.',
        ...
        },
        {
          ...
          alt:  '파스텔 마카롱 5개',
          tone: '감성 · 시각 톤',
          captionHtml: '오늘 만든 마카롱.<br>바닐라 · 민트 · 살구 · 라벤더 · 라즈베리.<br><br>저는 오늘 라벤더가 손에 잡혀요 💜',
          tags: '#마카롱 #홈베이킹 #카페디저트',
          likes: '❤️ 203',
          comments: '💬 15',
        },
        {
          ...
          alt:  '크로플 위 바닐라 아이스크림',
          tone: '감성 · 묘사',
          captionHtml: '바삭한 결 사이로<br>바닐라가 천천히 녹습니다.<br><br>빨리 드세요.<br>저도 사진 찍는 사이 한 입 사라졌어요 🍦',
        ...
        },
        {
          ...
          tone: '재미 · 여름 톤',
          captionHtml: '오늘 더워요.<br><br>블루베리 한 잔, 딸기 한 잔.<br>"하나만 골라야 해요?" 손님 질문에<br>"둘 다 드세요" 답변 드립니다 🍓',
          tags: '#스무디 #베리스무디 #여름음료',
          likes: '❤️ 94',
          comments: '💬 6',
        },
