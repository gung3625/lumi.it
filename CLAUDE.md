...
- **베타 SNS 자동화 SaaS**: 가격 미확정. 가입비 0원, 카드 등록 X 정책만 유지
- **정식 출시 가격**: 미확정. 베타 데이터로 추후 결정
- **카피·UI 룰**: 어떤 정량 가격값(₩29,000·₩19,900 등)도 단정 표기 금지. "출시 시 안내" 정도까지만
- 지원 채널: 인스타그램 비즈니스 계정 (추가 채널은 V2 추후 추가)
- 폐지된 Phase 0 가격(스탠다드 ₩19,900 / 프로 ₩29,900 / 비즈니스): 셀러향 카피·UI에서 노출 금지
- DM·댓글 AI 자동응답: 현재 비활성 (Meta 심사 통과 + 별도 동의 후 활성), 자동 발송 어필 X — 초안 제공까지만
- 사업자등록번호: **404-09-66416** (모든 페이지 통일)
- 서비스 상태: 베타, Meta 심사 중, SNS 자동화 한정 모집
