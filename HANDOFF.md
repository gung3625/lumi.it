...
#### 위생
- **#142 deprecated cron 헤더** — scheduled-trends-background.js (v2 통합, netlify.toml 주석) 에 명시. scheduled-ig-hashtag-background / scheduled-ig-token-refresh-background 는 in-code config.schedule 로 active 확인 (deprecated 아님).
...
- scheduled-trends-background.js 파일 자체 삭제 (destructive)
