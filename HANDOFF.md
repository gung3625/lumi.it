...
마지막 업데이트: 2026-05-12
기준 커밋: `main` 최신 (`42947ea`, PR #104 머지 완료) — PR #69~#104 36건 반영
...
총 **83개 함수**. 디렉토리: `netlify/functions/`
...
- `get-best-time.js` — 3-tier (Meta online_followers → 본인 이력 → 업종 시드). 응답에 `weekday`/`weekend` 배열 동봉.
