...
const NAVER_KEYWORDS = {
  ...
  fitness: [
    ...
    { groupName: '러닝브랜드', keywords: ['나이키런닝화신상', '호카신상', '온러닝추천'] },
...
## 카테고리별 범위
- cafe (카페·음료): 커피·라떼·음료·디저트·베이커리·케이크·마카롱·스콘·소금빵·크로플·푸딩·빙수·스무디, 카페 인테리어
...
- fitness (피트니스): 구체 프로그램·기구·운동복 브랜드 중심
  좋은 예) 룰루레몬얼라인, 리포머프라이빗, 케이블크로스, 나이키런닝화신상, 호카신상, 소울사이클
  나쁜 예) 헬스, 운동, 홈트, 다이어트운동, 필라테스 (카테고리 총칭 또는 목적+총칭)
