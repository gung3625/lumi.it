...
//
// 9개 엔드포인트 전체 통합 (2026-04-28 확정):
//   A. 검색어 트렌드 (이미 다른 모듈에서 사용 중, 여기는 쇼핑인사이트 전용)
...
//
// ⚠️ 시크릿 평문 로그 금지 (메모리 .claude/rules/security.md 준수)
...
// ─────────────────────────────────────────────
// Lumi 카테고리 (10업종) → 네이버 쇼핑 분류 코드 매핑
// 코드는 네이버 데이터랩 쇼핑인사이트 분야 트리 기준
// 정확한 코드는 네이버 측 공개 문서 / 실 호출로 검증 필요
// 참고: 50000000 ~ 50000009 = 1차 카테고리 (대표 코드)
// ─────────────────────────────────────────────
const LUMI_TO_NAVER_CATEGORY = {
  fashion: { code: '50000000', name: '패션의류' },         // 패션의류
  fashionAcc: { code: '50000001', name: '패션잡화' },       // 패션잡화
  beauty: { code: '50000002', name: '화장품/미용' },        // 화장품/미용
  digital: { code: '50000003', name: '디지털/가전' },       // 디지털/가전
  interior: { code: '50000004', name: '가구/인테리어' },    // 가구/인테리어
  baby: { code: '50000005', name: '출산/육아' },           // 출산/육아
  food: { code: '50000006', name: '식품' },                // 식품
  sports: { code: '50000007', name: '스포츠/레저' },        // 스포츠/레저
  health: { code: '50000008', name: '생활/건강' },          // 생활/건강
  leisure: { code: '50000009', name: '여가/생활편의' },     // 여가/생활편의
};
