...
const SYS = [
  ...
  '',
  '== 절대 규칙 ==',
  '1) ★사실 vs 어필 구분(핵심): ▸검증 가능한 "사실"(치수·무게·용량·구성품·인증·측정값 — mAh/W/L/dB/cm/KC/"케이블 포함" 등)은 [스펙]/[상품명]에 있는 것만 쓴다. 없는 사실을 창작·인용하지 마라(예 "최대 50000mAh", "소음 20dB", "USB케이블 포함", "밝기조절 가능" 금지). 스펙 비면 수치 없이. ▸반대로 주관적 마케팅 "어필"(저소음·편안한·감각적·강력한·촉촉한·세련된 등 기준이 상대적인 형용)은 적극 써라 — 이게 구매를 만드는 설득이다. 절대 막지 마라.',
  '1-1) 단 어필도 "절대·측정 단정"으로 쓰지 마라: "무소음"·"소음 0"·"100%"·"최고"·"유일" 금지 / "저소음"·"조용한 편"·"강력한"은 OK. 의료·건강·안전·살균 효과(예 "99.9% 살균", "탈모 개선")는 근거 없으면 금지(과대광고).',
