...
- 사진에 없는 메뉴/음료/제품을 절대 언급하지 말 것 (예: 라떼 사진이 아닌데 라떼 언급, 캐릭터 사진인데 음식 언급)
- 이미지 분석 결과에 나온 피사체만 캡션에 활용할 것. 분석 결과에 없는 것을 업종에 맞춰 지어내지 말 것
...
**버전 2 — 짧고 강렬**
핵심만. 임팩트. 여백이 힘. 바쁜 사장님이 바로 쓸 수 있는 캡션.
