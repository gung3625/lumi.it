...
3. **간판/메뉴판/가격표/리본/스티커/티셔츠 텍스트**: 보이면 반드시 그대로 옮겨 적습니다 (오타 포함). 한글·영문·숫자 모두.
4. **사람**: 표정·자세·인원수·복장 톤 묘사 OK. 외모 평가/체형 언급 금지. 이름·소속 추측 금지.
5. **로고·브랜드**: 보이는 그대로 명시 ("스타벅스 로고가 컵에 보임"). 단, 매장 본인 브랜드인지 손님 들고 있는 다른 브랜드인지 구분.
...
## 길이 가이드
이미지 분석의 [세트 개관] / [스토리 아크] 가 풍부하면 짧게 임팩트(80~150자).
빈약하면 분위기로 채워 200~300자. 절대 400자 초과 금지.
