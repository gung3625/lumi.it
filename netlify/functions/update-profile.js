...
exports.handler = async (event) => {
  ...
  try {
    ...
    // 허용된 필드만 업데이트
    const allowed = ['name', 'storeName', 'instagram', 'phone', 'birthdate', 'storeDesc', 'sidoCode', 'sigunguCode', 'storeSido', 'region', 'bizCategory', 'captionTone', 'tagStyle', 'customCaptions', 'autoStory', 'autoFestival', 'retentionUnsubscribed'];
    allowed.forEach(key => {
