...
| # | 파일 | 문제 | 상태 |
|---|------|------|------|
| HIGH-1 | reserve.js, save-reservation.js | Bearer 토큰 Blobs 미검증 | ✅ Bearer 안전 파싱 |
| HIGH-2 | regenerate-caption.js | 토큰 형식만 체크, email body | ✅ Blobs 검증 + email 토큰에서 추출 |
| HIGH-3 | select-caption.js, save-caption.js | LUMI_SECRET JSON body 노출 | ✅ 헤더로 이동 |
