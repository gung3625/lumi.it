...
## 보류 아이디어 (심사/데이터 축적 후 진행)
- [ ] 경쟁 매장 인스타 분석 리포트 — Meta Business Discovery API 필요, 메타 앱 심사 통과 후 진행
- [ ] 캡션 성과 예측 점수 — 실사용 데이터 축적 후 의미 있음, 데이터 쌓인 후 진행
- [ ] DM 자동 답변 — 메타 앱 심사 완료 후 구현 예정
- [ ] 스레드(Threads) 동시 게시 — 메타 앱 심사 완료 후 구현 예정
- [ ] 인스타그램 인사이트 조회 — 메타 앱 심사 완료 후 구현 예정
